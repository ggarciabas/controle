...
/**
 *  Class Proxy
 *      Define o padrão proxy.
 *      O proxy deverá ser único para cada pessoa logada no sistema. ** Juliano
 *  
 * @author Giovanna Garcia
 * @author Marcos Agnes
 */
public class Proxy implements GerenciarPessoa, GerenciarReservas, GerenciarSala {
    
    private Pessoa m_pessoa = null;
    private Sala m_sala = null;

    public Proxy(Pessoa m_pessoa) {
